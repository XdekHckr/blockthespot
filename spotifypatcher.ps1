...
- Check for patcher script updates, Uninstall Spotify (if you have preinstalled
- Microsoft Store version of spotify then uninstall it).
- Disable Antivirus/Windows Defender, firewall (while installing).
...
function Show-ChoicePrompt {
    ...
    $choice = Read-Host -Prompt "$Message [Y]es or [N]o"
...
$choiceResult = Show-ChoicePrompt -Message 'Would you like to visit my channel?'

switch ($choiceResult) {
    1 { 'Opening link...'; Start-Process "https://www.youtube.com/channel/UCW33e4MCfEdPORh206UTcyA?sub_confirmation=1" }
    2 { 'Cancelled...' }
    default {
        'No response. Opening link in 5 seconds...'
        Start-Sleep -Seconds 5
        'Opening link...'; Start-Process "https://www.youtube.com/channel/UCW33e4MCfEdPORh206UTcyA?sub_confirmation=1"
    }
}
...
Ca y skrypt z modyfikacj  koloru b dzie wygl da  tak:
